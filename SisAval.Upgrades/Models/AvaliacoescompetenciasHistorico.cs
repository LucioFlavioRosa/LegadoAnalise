...
{
    [Table("AVALIACOESCOMPETENCIAS_HISTORICO")]
    public partial class AvaliacoescompetenciasHistorico
    {
        [Key]
        ...
        [Column("DataHoraiNICIOAutoAvaliacao", TypeName = "datetime")]
        ...
        [ForeignKey(nameof(IdAvaliacaoCompetencia))]
        [InverseProperty(nameof(Avaliacoescompetencia.AvaliacoescompetenciasHistoricos))]
        public virtual Avaliacoescompetencia IdAvaliacaoCompetenciaNavigation { get; set; }
    }
}
