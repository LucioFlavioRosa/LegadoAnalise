...
{
    /// <summary>
    /// Implementação concreta de ICargoRepository utilizando ADO.NET.
    /// </summary>
    public class CargoRepository : ICargoRepository
    {
        ...
        private Cargo MapearCargo(IDataReader reader)
        {
            return new Cargo
            {
                ...
                TempoMinimoPromocao = reader["TempoMinimoPromocao"] != DBNull.Value ? Convert.ToInt32(reader["TempoMinimoPromocao"]) : 0,
