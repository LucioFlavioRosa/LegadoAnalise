<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="consulta_avancada.aspx.cs" Inherits="SistemaAvaliacao.consulta_avancada" %>
    ...
    <div class="page-breadcrumb border-bottom">
        <div class="row">
            <div class="col-lg-3 col-md-4 col-xs-12 align-self-center">
                <h5 class="font-medium text-uppercase mb-0">Consulta Avançada</h5>
            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <div class="form-group">
                                            <label>Fase</label>
                                            <asp:DropDownList ID="ddlFase" CssClass="form-control p-0 select2" Style="width: 100%" runat="server">
                                                <asp:ListItem Value="">[Selecionar]</asp:ListItem>
                                                <asp:ListItem Value="AVM">Não Iniciado</asp:ListItem>
                                                <asp:ListItem Value="AAV">Auto Avaliação</asp:ListItem>
                                                <asp:ListItem Value="ACE">As Cegas</asp:ListItem>
