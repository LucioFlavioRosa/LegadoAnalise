<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="avalizacao_feedback.aspx.cs" Inherits="SistemaAvaliacao.avalizacao_feedback" %>
            ...
            <div class="col-lg-9 col-md-8 col-xs-12 align-self-center">
                <nav aria-label="breadcrumb" class="mt-2 float-md-right float-left">
                    <ol class="breadcrumb mb-0 justify-content-end p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Avaliação / Feedback</li>
                    </ol>
                </nav>
            </div>
        </div>
                                                ...
                                                <ItemTemplate>
                                                    <tr>
                                                        ...
                                                        <td style="text-align:right;">
                                                            <br />
                                                            <a href="avalizacao_feedback_competencia.aspx?IdProjeto=<%# Eval("Projeto.IdProjeto") %>&IdAssociado=<%# Eval("Associado.IdAssociado") %>&IdPeriodo=<%# Eval("Periodo.IdPeriodo") %>&TipoAvaliacao=<%# Eval("TipoAvaliacao") %>&Escopo=<%# Eval("Escopo") %>&idGestor=<%# Eval("Gestor.IdAssociado") %>">
                                                                <button type="button" class="btn btn-info" <%# Eval("IsHidden") %> <%# Eval("ExibirFeedback") %>><%# DataBinder.Eval(Container.DataItem, "RotuloBotao") %></button>
                                                            </a>
