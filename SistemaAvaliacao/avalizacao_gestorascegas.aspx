<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="avalizacao_gestorascegas.aspx.cs" Inherits="SistemaAvaliacao.avalizacao_gestorascegas" %>
    ...
    <div class="page-breadcrumb border-bottom">
        <div class="row">
            <div class="col-lg-3 col-md-4 col-xs-12 align-self-center">
                <h5 class="font-medium text-uppercase mb-0">Avaliação do Gestor às Cegas</h5>
            </div>
            <div class="col-lg-9 col-md-8 col-xs-12 align-self-center">
                <nav aria-label="breadcrumb" class="mt-2 float-md-right float-left">
                    <ol class="breadcrumb mb-0 justify-content-end p-0">
                        <li class="breadcrumb-item"><a href="index.aspx">Peers</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Avaliação / Gestor às Cegas</li>
                    </ol>
                </nav>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <asp:Repeater ID="rptProjetos" runat="server">
                                <HeaderTemplate>
                                    <table class="table table-striped border dtInit" id="dtInit">
                                        <thead>
                                            <tr>
                                                <th>Código</th>
                                                <th>Projeto</th>
                                                        ...
                                                        <table class="table table-striped border">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th>Término</th>
                                                                    <th>Gestor</th>
                                                                    <th oninit="colAvaliador_Init" ID="colAvaliador" runat="server">Avaliador</th>
                                                    ...
                                                    <ItemTemplate>
                                                        <tr>
                                                            ...
                                                            <td style="text-align: right;">
                                                                <br />
                                                                <a href="avalizacao_gestorascegas_competencia.aspx?IdProjeto=<%# Eval("Projeto.IdProjeto") %>&IdAssociado=<%# Eval("Associado.IdAssociado") %>&IdPeriodo=<%# Eval("Periodo.IdPeriodo") %>&TipoAvaliacao=<%# Eval("TipoAvaliacao") %>&Escopo=<%# Eval("Escopo") %>&idGestor=<%# Eval("Gestor.IdAssociado") %>">
