<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="avalizacao_gestor_performance.aspx.cs" Inherits="SistemaAvaliacao.avalizacao_gestor_performance" %>
                            ...
                            <asp:Repeater ID="rptPerformances" runat="server" OnItemDataBound="rptPerformances_ItemDataBound">
                                <ItemTemplate>
                                    <tr <%# Eval("SeparadorAbrangencia") %>>
                                        <td colspan="8" style="text-align:center;font-size:16px"><%# Eval("Abrangencia") %></td>
                                    </tr>
                                    <tr <%# Eval("Input") %>>
                                        <td>
                                    ...
                                    <tr <%# Eval("Input") %>>
                                        <td colspan="8" class="hiddenRow">
                                            <div class="accordian-body collapse" id="obs_<%# Eval("IdPerformance") %>">
                                                ...
                                                <p>
                                                    <strong>Observações as Cegas:</strong><br>
                                                    <asp:Label ID="lblObservacaoCegas" runat="server"></asp:Label>
                                                </p>
                                                <p>
                                                    <strong>Considerações do Gestor:</strong><br />
        ...
        <div class="card">
            <div class="card-body">
                    ...
                    <div class="text-left">
                        ...
                        <button type="button" class="btn btn-facebook" disabled>Performance</button>
                        <asp:Button ID="Button2" runat="server" Text="Ir para Finalização" class="btn btn-info" OnClick="btnFinalizar_Click" />
                    </div>
                </div>
            </div>
        </div>
