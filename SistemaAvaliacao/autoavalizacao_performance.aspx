<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="autoavalizacao_performance.aspx.cs" Inherits="SistemaAvaliacao.autoavalizacao_performance" %>
    ...
    <div class="page-content container-fluid">
                            ...
                            <asp:Repeater ID="rptPerformances" runat="server" OnItemDataBound="rptPerformances_ItemDataBound">
                                <ItemTemplate>
                                    ...
                                    <tr <%# Eval("Input") %>>
                                        ...
                                        <td>
                                            <a href="#abaixo_<%# DataBinder.Eval(Container.DataItem,"IdPerformance") %>" data-target="#abaixo_<%# DataBinder.Eval(Container.DataItem,"IdPerformance") %>" 
        ...
        <div class="card">
            <div class="card-body">
                    <div class="col-md-5">
                    <div class="text-left">
                        <asp:Button ID="btn_Competencia_2" runat="server" Text="Competencia" class="btn btn-danger" OnClick="btnIrCompetencia_Click" />
                        <button type="button" class="btn btn-facebook" disabled>Performance</button>
