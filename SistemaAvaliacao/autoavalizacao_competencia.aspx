<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="autoavalizacao_competencia.aspx.cs" Inherits="SistemaAvaliacao.autoavalizacao_competencia" %>
                        ...
                        <div id="Detalhes" class="collapse" aria-labelledby="headingDetalhes" data-parent="#accordionDetalhes">
                            <div class="col-md-5">
                                <div class="text-left">
                                    ...
                                    <asp:Button ID="btnIrPerformancebtnIrPerformance" runat="server" Text="Performance" class="btn btn-danger" OnClick="btnIrPerformance_Click" />
                    ...
                    <table class="table table-striped border" style="border-collapse:collapse !important; width: 100% !important">
                        <thead>
                            ...
                            <tr>
                                ...
                                <th runat="server" id="tableDetalheNivel2" colspan="4" style="position:sticky !important; top:45px !important;color:#021240;background-color:#eae678;border-bottom:6px solid;border-color:#eae678"><asp:Label ID="lblDetalheNivel2" runat="server" Text="Detalhamento Próximo Nível"></asp:Label></th>                                
            ...
            <div class="card">
                <div class="card-body">
                     <div class="col-md-5">
                        <div class="text-left">
                            <button type="button" class="btn btn-facebook" disabled>Competência</button>
                            <asp:Button ID="btn_Performances_2" runat="server" Text="Performance" class="btn btn-danger" OnClick="btnIrPerformance_Click" />
