<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SubCompetencias.aspx.cs" Inherits="SistemaAvaliacao.SubCompetencias" %>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtSubCompetencia" class="form-control" runat="server"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    ...
                    <asp:Repeater ID="rptSubCompetencias" OnItemCommand="rpt_ItemCommand" OnItemDataBound="rpt_ItemDataBound" runat="server">
                        ...
                        <ItemTemplate>
                            <tr>
                                <td><asp:Label ID="lblId" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "IdSubCompetencia") %>' Visible="false"></asp:Label><%# DataBinder.Eval(Container.DataItem, "IdSubCompetencia") %></td>
                                <td><%# DataBinder.Eval(Container.DataItem, "SubCompetencia") %></td>
